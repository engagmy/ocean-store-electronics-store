package com.oceanstore.store.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.oceanstore.store.service.EmailAlreadyUsedException ||
            ex instanceof com.oceanstore.store.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.oceanstore.store.service.InvalidPasswordException
